//Right now the program only checks for Y and H and assumes if it
...
//How do you loop the ask until a correct answer is given? It can receive strings --> NaN
//Add a cheat detector - keep track of the numbers that can't be right and compare the guess to that range
//secretNumber isn't currently used - not sure it's needed if we're asking for a Y/N
